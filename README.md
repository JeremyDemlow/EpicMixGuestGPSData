...
```
This command will create your personal repository under `/Repos/<username>/gps`.
...
- To trigger the release pipeline, get the current version from the `gps/__init__.py` file and tag the current code version:
```
